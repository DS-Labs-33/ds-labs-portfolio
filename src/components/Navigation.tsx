        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={toggleTheme}
              className="p-2 rounded-full border border-[var(--border)] bg-[var(--background)] hover:bg-[var(--border)] text-[var(--foreground)] transition-colors mr-2 flex items-center justify-center"
            ...
            >
              ...
              >
                {showSunIcon ? (
                  ...
                  <svg className="w-4 h-4 rotate-[15deg]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex flex-col gap-2 pt-4 mt-2 border-t border-[var(--border)]">
                ...
                >
                  {showSunIcon ? (
                    ...
                    <><svg className="w-4 h-4 rotate-[15deg]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /></svg> Dark Mode</>
                  )}
                </button>
                <a
                  href="#contact"
